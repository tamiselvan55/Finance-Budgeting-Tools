  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-800 text-white p-6 relative">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {msg && (
          <div className="mb-3 p-2 bg-indigo-700 rounded text-center">
            {msg}
          </div>
        )}
        ...
        <div className="space-y-3">
          ...
          {tx.map((t) => (
            <div
              key={t._id}
              className="bg-white/10 p-4 rounded flex justify-between items-start shadow-md hover:bg-white/20 transition rounded-lg"
            >
              <div>
